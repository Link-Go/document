...
class EvaluationRecord(Base):
    ...
    status = Column(Enum("waiting", "evaluating", "finished", "cancel",
                         "failure"),
                    default="waiting",
                    doc='评估状态')
...
class EvaluationItems(Base):
    ...
    evaluation_id = Column(Integer,
                           ForeignKey(EvaluationRecord.id),
                           doc='评估记录id')
...
class OperationRecord(Base):
    ...
    evaluation_id = Column(Integer,
                           ForeignKey(EvaluationRecord.id),
                           doc='评估记录id')
    evaluation_items_id = Column(Integer,
                                 ForeignKey(EvaluationItems.id),
                                 doc='评估项记录ID')
    ...
    evaluation_items = relationship("EvaluationItems",
                                    backref="operation_record")
